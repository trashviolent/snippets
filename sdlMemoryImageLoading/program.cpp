			...
			if (this->frameData[a].frameImageDataNum != previousImageNum) {
				...
				if (this->frameData[a].frameImageDataNum != 0) {
					...
					for (size_t b = 0; b < this->frameData[a].frameImageDataNum; ++b) {
						this->frameData[a].frameImageData[b].frameX = this->worldImageData[worldImageDataToBeUsedIndex[b]].worldX;
						this->frameData[a].frameImageData[b].frameY = this->worldImageData[worldImageDataToBeUsedIndex[b]].worldY;
